...
;Experigen.make_into_trial = function (that) {
	...
	that.makeScale = function(obj) {
		...
		for (var i=0; i<buttons.length; i+=1) {
			...
			str += '<input type="' + buttontype + '" value="'+ buttons[i] +'" id="' + Experigen.screen().responses + 'button' + i + '" name="scale'+ Experigen.screen().responses +'" class="scaleButton" onClick="this.Experigen.screen().recordResponse(' + Experigen.screen().responses + "," + "'" + buttons[i] + "'" + '); Experigen.screen().continueButtonClick(this,{disable:' + disable + '});';
